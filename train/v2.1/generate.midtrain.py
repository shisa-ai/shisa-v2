...
def main():
    ...
    datasets_config = [
        ...
        ### More stuff...
        {
            "dataset_path": "shisa-ai/wip-tulu-3-math-code-all",
            "field_messages": "conversations",
            "split": "train",
        },
        {
            "dataset_path": "shisa-ai/shisa-ai/tulu-3-sft-mixture_translated",
            "field_messages": "messages",
            "split": "train",
        },
        {
            "dataset_path": "shisa-ai/shisa-ai/tulu-3-sft-mixture_translated",
            "field_messages": "original_messages",
            "split": "train",
        },
        {
            "dataset_path": "shisa-ai/master-magpie-set",
            "field_messages": "original_messages",
            "split": "train",
        },
