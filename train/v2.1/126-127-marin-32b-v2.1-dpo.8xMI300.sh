...
# MODELS
ORIG_MODEL=${ORIG_MODEL:-"nvidia/NVIDIA-Nemotron-Nano-12B-v2"}

SFT_CKPT=${SFT_CKPT:-"126-nemotron-nano-12b-v2.1-sft"}
SFT_DATA="sft.shisa-v2.1.jsonl"
SFT_LR=${SFT_LR:-8.16e-06}
SFT_MBS=4

DPO_CKPT=${DPO_CKPT:-"127-nemotron-nano-12b-v2.1-dpo"}
# DPO_DATA="shisa-ai/shisa-v2-dpo405b-shuffled"
DPO_DATA="dpo.shisa-v2.1.jsonl"
DPO_LR=${DPO_LR:-1.02e-07}
DPO_MBS=2
