...
# MODELS
ORIG_MODEL=${ORIG_MODEL:-"tokyotech-llm/Llama-3.1-Swallow-8B-Instruct-v0.5"}

SFT_CKPT=${SFT_CKPT:-"032-swallow-8b-0.5-instruct-v2new-sft"}
SFT_DATA="sft.shisa-v2-new.jsonl"
SFT_LR=${SFT_LR:-1e-5}
SFT_MBS=4

DPO_CKPT=${DPO_CKPT:-"033-swallow-8b-0.5-v2new-dpo405b"}
