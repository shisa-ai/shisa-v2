...
# MODELS
ORIG_MODEL=${ORIG_MODEL:-"microsoft/Phi-4-mini-instruct"}

SFT_CKPT=${SFT_CKPT:-"048-phi4-mini-3.8b-v2new-sft"}
SFT_DATA="sft.shisa-v2-new.jsonl"
SFT_LR=${SFT_LR:-1.45e-5}
SFT_MBS=16

DPO_CKPT=${DPO_CKPT:-"049-phi4-mini-3.8b-v2new-dpo405b"}
DPO_DATA="shisa-ai/shisa-v2-dpo405b-shuffled"
DPO_LR=${DPO_LR:-1.81e-07}
DPO_MBS=16
