...
# MODELS
ORIG_MODEL=${ORIG_MODEL:-"sbintuitions/sarashina2.2-3b-instruct-v0.1"}

SFT_CKPT=${SFT_CKPT:-"038-sarashina2.2-3b-instruct-v2new-sft"}
SFT_DATA="sft.shisa-v2-new.jsonl"
SFT_LR=${SFT_LR:-1.63e-5}
SFT_MBS=64

DPO_CKPT=${DPO_CKPT:-"039-sarashina2.2-3b-instruct-v2new-dpo405b"}
