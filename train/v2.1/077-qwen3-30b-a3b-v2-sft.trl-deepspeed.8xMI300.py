...
OUT = "076-qwen3-30b-a3b-v2-sft-trl"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='TRL Training Script for Qwen3-30B-A3B-v2 SFT')
...
def run_with_accelerate():
    print("Starting TRL training with FSDP...")
