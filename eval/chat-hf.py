...
models = {
    ...
    'shisa-v1-llama3-70b': {
        'prompt': 'You are a helpful assistant.',
        'model' : 'shisa-ai/shisa-v1-llama3-70b',
        'format': 'llama3',
    },
    'Qwen2-7B-Instruct': {
        'prompt': 'You are a helpful assistant.',
...
def _(event):
    multiline_mode[0] = not multiline_mode[0]  # Toggle the multiline mode

# Condition to check the current state of multiline_mode
is_multiline = Condition(lambda: multiline_mode[0])
...
def chat_with_model():
    ...
    while True:
        ...
        user_input = prompt("User: ", multiline=is_multiline, key_bindings=key_bindings)
